...
public class TokenSlot : MonoBehaviour
{
    ...
    public PlayerTokenScriptable myCardToken;
    ...
    public void SetToken(PlayerTokenScriptable myNewCardToken, bool isPlayedAsCard = false, int remainingEnergy = 1)
    {
    ...
    private void OnMouseEnter()
    {
        ...
        if (hasToken)
        {
            CardManager.instance.previewCard.GetComponent<MainCardScript>().myPlayerTokenScriptable = this.myCardToken;
